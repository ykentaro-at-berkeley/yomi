...
ocamlbuild -cflags -annot,-g -lflag -g -use-ocamlfind -pkgs lwt,js_of_ocaml,js_of_ocaml-lwt,js_of_ocaml.ppx kaga.byte rokutan.byte
errno=$?
...
js_of_ocaml --opt 3 rokutan.byte
exit $errno
