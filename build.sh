...
ocamlbuild -cflags '-annot,-g,-w @10' -lflag -g -use-ocamlfind -pkgs lwt,js_of_ocaml,js_of_ocaml-lwt,js_of_ocaml.ppx,ppx_deriving,ppx_typerep_conv,typerep rokutan.byte
ocamlbuild -cflags -annot,-g -lflag -g -use-ocamlfind -pkgs netcgi2,unmagic,ppx_deriving,ppx_typerep_conv,typerep remoteRokutan.native
errno=$?
...
js_of_ocaml --opt 3 +base/runtime.js mkb.byte 
